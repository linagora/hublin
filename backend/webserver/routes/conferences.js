...
module.exports = function(dependencies) {
  ...
  router.put('/api/conferences/:id', middlewares.checkIdForCreation, middlewares.load, middlewares.lazyArchive(true), user.load, middlewares.addUserOrCreate, controllers.createdOrUpdated);
